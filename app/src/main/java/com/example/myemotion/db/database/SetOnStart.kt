...
class SetOnStart(dbHelper: EmotionDatabaseHelper) {
    ...
    fun initializeDatabase() {
        ...
        val consiglio1 = Consiglio(consiglio = "Sorridi di più", idEmozione = idEmozione1.toInt(), numDiVolteVisualizzata = 0)
        val consiglio2 = Consiglio(consiglio = "Parla con un amico", idEmozione = idEmozione2.toInt(), numDiVolteVisualizzata = 0)
        val consiglio3 = Consiglio(consiglio = "Fai un respiro profondo", idEmozione = idEmozione3.toInt(), numDiVolteVisualizzata = 0)
        val consiglio4 = Consiglio(consiglio = "Affronta le tue paure", idEmozione = idEmozione4.toInt(), numDiVolteVisualizzata = 0)
